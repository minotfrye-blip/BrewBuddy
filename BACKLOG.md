...
| ID | Type | Summary |
|----|------|---------|
| BB-005 | Feature | Time-off-boil timer + drain timer with stopwatch logging |
...
| BB-010 | UX | Prompts varied temp by roast level -- locked to just off boil for all beans | Mar 2026 |
